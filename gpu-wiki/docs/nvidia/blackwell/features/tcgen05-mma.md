...
These are source-reported end-to-end stages; the final row combines persistence,
CLC, and the preceding kernel changes. It is not an isolated measurement of CLC.
