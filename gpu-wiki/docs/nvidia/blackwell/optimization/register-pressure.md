...
|---|---|---|
| [TMEM](../features/tmem.md) | SM100 only | Moves accumulators to dedicated 256KB memory |
| [Warp specialization](warp-specialization.md) | SM100+ | Different warps handle different roles, reducing per-warp register needs |
| [Register-to-TMEM migration](../features/tmem-porting.md) | SM90→SM100 | Systematic approach to moving accumulators off registers |
...
- [Register Pressure and Warp Occupancy](../../common/register-pressure-warp-occupancy.md)
